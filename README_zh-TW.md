...
**我們落後上游的地方**（多數 ⚠️）：**Constructor Inference** 是最大缺口 — Python、TypeScript、JavaScript 已完成 receiver-type binding，其他 11 種都還是 partial。**Frameworks & Entry Points** 在 Kotlin / C# / Swift / C / C++ / Dart 沒接（上游全部有，我們 parser 在但沒接 framework helper）。
