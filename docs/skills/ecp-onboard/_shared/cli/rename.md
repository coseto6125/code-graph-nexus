...
Options:
      ...
      --show-heuristic-mirrors  Expand the heuristic mirror list in the output. When unset, only the count is shown. Tier/check data is a T-H2 placeholder; T4-7 populates real values
