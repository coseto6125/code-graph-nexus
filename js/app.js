...
const K = Object.freeze({
    ...
    H_PEERS_TITLE: 'highlights.peers.title',
    H_PEERS_DESC: 'highlights.peers.desc',
...
const TRANSLATIONS = {
    'zh-TW': {
        ...
        [K.H_PEERS_DESC]: '突破單一 Session 限制。讓多個 Agent 互通髒資料 (Dirty surface) 狀態，在編寫程式碼前就能避開語意衝突與重工，實現大規模 Agent 並行開發。',
        [K.NAV_MATRIX]: '支援語系',
        [K.NAV_SETUP]: '快速開始',
        ...
        [K.HERO_TAGLINE]: 'Built for agents, not IDEs, not Humans.',
        [K.HERO_SUBTITLE]: '圖譜即時同步 · 上帝視角看 code · Agent ↔ code ↔ Agent',
    ...
    'zh-CN': {
        [K.META_TITLE]: 'Egent Code Plexus',
        [K.HERO_TAGLINE]: 'Built for agents, not IDEs, not Humans.',
        [K.HERO_SUBTITLE]: '图谱实时同步 · 上帝视角看 code · Agent ↔ code ↔ Agent',
        [K.INSTALL_MAC_LINUX]: 'macOS / Linux',
        [K.INSTALL_WINDOWS]: 'Windows (PowerShell)',
    ...
    'en': {
        [K.META_TITLE]: 'Egent Code Plexus',
        [K.HERO_TAGLINE]: 'Built for agents, not IDEs, not Humans.',
        [K.HERO_SUBTITLE]: 'Live-synced graph · God-mode view of code · Agent ↔ code ↔ Agent',
        [K.INSTALL_MAC_LINUX]: 'macOS / Linux',
        [K.INSTALL_WINDOWS]: 'Windows (PowerShell)',
    ...
    'ja': {
        [K.META_TITLE]: 'Egent Code Plexus',
        [K.HERO_TAGLINE]: 'Built for agents, not IDEs, not Humans.',
        [K.HERO_SUBTITLE]: 'ライブ同期グラフ · コードを神視点で · Agent ↔ code ↔ Agent',
        [K.INSTALL_MAC_LINUX]: 'macOS / Linux',
        [K.INSTALL_WINDOWS]: 'Windows (PowerShell)',
    ...
    'ko': {
        [K.META_TITLE]: 'Egent Code Plexus',
        [K.HERO_TAGLINE]: 'Built for agents, not IDEs, not Humans.',
        [K.HERO_SUBTITLE]: '실시간 동기화 그래프 · 코드를 위에서 한눈에 · Agent ↔ code ↔ Agent',
        [K.INSTALL_MAC_LINUX]: 'macOS / Linux',
        [K.INSTALL_WINDOWS]: 'Windows (PowerShell)',
    ...
    'es': {
        [K.META_TITLE]: 'Egent Code Plexus',
        [K.HERO_TAGLINE]: 'Built for agents, not IDEs, not Humans.',
        [K.HERO_SUBTITLE]: 'Grafo en vivo · Vista panorámica del código · Agent ↔ code ↔ Agent',
        [K.INSTALL_MAC_LINUX]: 'macOS / Linux',
        [K.INSTALL_WINDOWS]: 'Windows (PowerShell)',
        [K.INSTALL_CARGO]: 'Cargo (Construir desde fuente)',
        [K.INSTALL_COPIED]: '¡Copiado!',
        [K.NAV_SETUP]: 'Inicio Rápido',
        [K.NAV_MATRIX]: 'Idiomas',
